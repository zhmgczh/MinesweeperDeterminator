...
public class MinesweeperScanner {
    ...
    public MinesweeperState scan(ScreenData screen, boolean debug) {
        assert screen != null;
...
//        ScreenData screen = ScreenCapture.load_screen_from_file("test_images/final.png");
        ...
        ArrayList<Pair<Pair<Integer, Integer>, Character>> predictions = state.get_predictions(1, start + time_upper_limit);
